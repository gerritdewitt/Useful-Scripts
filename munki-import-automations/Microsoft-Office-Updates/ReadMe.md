...
2. Run the *make-pkginfo.py* script and follow its prompts to generate the *pkginfo* file.  For example:
   ...
   * It will ask for other details, depending on the type selection:
      ...
      - If adding a standalone app, the script requests the minimal version of macOS required by the app.  Refer to Microsoft release notes.  Version 10.9 is set as the minimum for other items; 10.10 for Office 2016.
