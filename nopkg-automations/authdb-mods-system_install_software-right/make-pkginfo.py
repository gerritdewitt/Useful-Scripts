...
# Script for creating a "nopkg" Munki item
# for making changes to the Authorization Policy Database.
...
def main():
    ...
    ITEM_MUNKI_NAME = "Configuration_Install_Software_All_Session_Users"
