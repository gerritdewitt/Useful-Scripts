...
def make_mobileconfig():
    ...
    mobileconfig_top_dict['PayloadIdentifier'] = "%(org)s.config.profile.apple-imovie-first-run" % {"org":ORGANIZATION_ID_PREFIX}
    ...
    mcx_preference_settings_dict['LKLastWelcomeVersionDisplayed'] = int(20)
    mcx_preference_settings_dict['LKLastWhatsNewVersionDisplayed'] = int(20)
    mcx_preference_settings_dict['FFiMovieUpgradeFirstRun'] = False
    payload_mcx_dict = {}
    ...
    payload_mcx_dict['PayloadIdentifier'] = "%s.config.payload.com.apple.ManagedClient.preferences.com.apple.iMovieApp" % ORGANIZATION_ID_PREFIX
    payload_mcx_dict['PayloadDisplayName'] = "iMovie First Run Settings"
    payload_mcx_dict['PayloadDescription'] = "Disables welcome and what's new messages"
    payload_mcx_dict['PayloadContent'] = make_managed_client_payload_content(mcx_preference_settings_dict,'Forced','com.apple.iMovieApp')
...
def main():
    ...
    CONFIG_PROFILE_FILE_NAME = "Configuration_Apple_iMovie_Disable_First_Run.mobileconfig"
    CONFIG_PROFILE_VERSION = raw_input("Profile version (example: 2017.06): ")
    PKGSINFO_FILE_NAME = "Configuration_Apple_iMovie_Disable_First_Run-%s" % CONFIG_PROFILE_VERSION
    ...
    CONFIG_PROFILE_VARS_DICT['TOP_DISPLAY_NAME'] = raw_input("Profile display name (example: iMovie First Run Settings): ")
