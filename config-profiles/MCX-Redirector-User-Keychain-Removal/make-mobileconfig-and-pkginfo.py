...
# profile with a com.apple.MCXRedirector MCX payload
# to delete ~/Library/Keychains at logout.
...
def make_mobileconfig():
    ...
    mobileconfig_top_dict['PayloadIdentifier'] = "%s.profile.apple-mcx-redirector.user-keychain-removal-logout" % ORGANIZATION_ID_PREFIX
    ...
    mcx_preference_settings_dict['LogoutRedirection'] = []
    redirection_dict = {"action":"deletePath",
                        "path":"~/Library/Keychains"
                        }
    mcx_preference_settings_dict['LogoutRedirection'].append(redirection_dict)
    payload_mcx_dict = {}
    ...
    payload_mcx_dict['PayloadIdentifier'] = "%s.config.payload.com.apple.ManagedClient.preferences.com.apple.MCXRedirector" % ORGANIZATION_ID_PREFIX
    payload_mcx_dict['PayloadDisplayName'] = "Folder Redirection"
    payload_mcx_dict['PayloadDescription'] = "Deletes user keychains on logout."
    payload_mcx_dict['PayloadContent'] = make_managed_client_payload_content(mcx_preference_settings_dict,'Forced','com.apple.MCXRedirector')
...
def main():
    ...
    CONFIG_PROFILE_FILE_NAME = "Configuration_MCX_Redirector_User_Keychain_Removal_Logout.mobileconfig"
    CONFIG_PROFILE_VERSION = raw_input("Profile version (example: 2016.10): ")
    PKGSINFO_FILE_NAME = "Configuration_MCX_Redirector_User_Keychain_Removal_Logout-%s" % CONFIG_PROFILE_VERSION
    ...
    CONFIG_PROFILE_VARS_DICT['TOP_DISPLAY_NAME'] = raw_input("Profile display name (example: User Keychain Removal at Logout): ")
